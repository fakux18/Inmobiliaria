        ...
        <div className="max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-[#f4b400] duration-200 transition" aria-label="Facebook">
              ...
              <a href="#" className="hover:text-[#f4b400] duration-200 transition" aria-label="Twitter">
                <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
